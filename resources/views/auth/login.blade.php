<x-guest-layout>
    ...
    <div class="w-full">
        ...
        <div class="mb-8 text-center">
            ...
            <p class="text-silver text-sm">Sign in to continue your shopping journey</p>
        </div>
            ...
            <div class="flex items-center justify-between pt-1">
                <label for="remember_me" class="flex items-center cursor-pointer group">
                    <input id="remember_me" type="checkbox" name="remember"
                        class="w-4 h-4 bg-white border-stone-300 rounded text-ink focus:ring-2 focus:ring-ink focus:ring-offset-0 transition-colors cursor-pointer">
                    <span class="ml-2 text-sm text-silver group-hover:text-ink transition-colors">Remember me</span>
                </label>
